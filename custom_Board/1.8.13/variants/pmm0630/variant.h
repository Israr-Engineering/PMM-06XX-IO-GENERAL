...
#define PMM_DI_PROG01      (31u) //PA27 : Digital Input - general (front panel dip switch )
#define PMM_DI_PROG02      (46u) //PA03 : Digital Input - general (front panel dip switch)

#define PMM_DI_LossOfPower        (16u)//PBA15 : Digital Input :loos of power 
//03c. Serial RS485
#define PMM_DO_RDENA              (15u)//PA14 : Digital output : RS485 Direction control  
//03b. Flash memory
#define PMM_DO_FLASH_CS           (32u)//PA28 : Digital output : Flash chip select command 

#define PMM_DO_SCSn    (18u) //PA18 : Digital output : Ethernet controller chip select command  
#define PMM_S0         (10u) //PA20
#define PMM_S1         (11u) //PA21
#define PMM_S2         (24u) //PB09
#define PMM_CS         (25u) //PA04
#define PMM_SWCLK      (48u) //PA30
#define PMM_SWDIO      (49u) //PA31
#define PMM_DIN        (22u) //PA02
...
//End Mandatory:
 ...
 //* Analog pins (not defined for PMM0630)
...
// Serial1 (not defined for PMM0630)
