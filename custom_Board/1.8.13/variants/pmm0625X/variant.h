...
//#define PMM_DO_ETH_RST     (21u) //PA19 : Digital output : Ethernet controller reset command
//#define PMM_D1_ETH_INT     (11u) //PA20 : Digital Input : Ethernet controller interrupt 
