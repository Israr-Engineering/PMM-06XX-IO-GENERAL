...
#define PMM_DI_INT          (10u) //PA03 : Digital Input : General interrupt from RTC or Extension boards  
#define PMM_DI_PROG         (15u) //PB08 : Digital Input for programming mode - near termination dip switch
#define PMM_ERROR           (4u) //PB09
#define PMM_SD_CS          (4u) //PA04
#define PMM_DO_FLASH_CS     (8u) //PA05 : Digital output : Flash chip select command 
#define PMM_DO_FLASH_EN     (9u) //PA13 : Digital output : Flash chip select command 
#define PMM_DI_LossOfPower  (5u) //PA14 : Digital Input :loos of power 
#define PMM_DO_SCSn         (21u) //PA18 : Digital output : Ethernet controller chip select command  
#define PMM_wizRST          (4u) //PA19
#define PMM_AI_INTn         (11u)//PA20 :
#define PMM_DO_RDENA        (7u) //PA27 : Digital output : RS485 Direction control  
...
#define PMM_ZRTS            (11u) //PA07
#define PMM_Dio10           (22u) //PA16
#define PMM_NRST            (18u) //PA14
#define PMM_BUSY            (19u) //PA15
#define PMM_Lora_CS         (13u) //PA20
#define PMM_LoraRST         (14u) //PA21
#define PMM_DO_ETH_RST      (24u) //PA17 : Digital output : Ethernet controller reset command
#define PMM_D1_ETH_INT      (6u) //PA08 : Digital Input : Ethernet controller interrupt 
#define PMM_RUN             (14u) //PA21
...
//03. Internal signals
 ...
 //* Analog pins (not defined for PMM0632)
...
// Serial1 (not defined for PMM0632)
