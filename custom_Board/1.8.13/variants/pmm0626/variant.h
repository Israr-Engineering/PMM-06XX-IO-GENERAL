...
#define PMM_DI_PROG02        (6u) //PA08 : Digital Input - general (front panel dip switch)
//03. Internal signals
...
//03d. options 
#define PMM_DI_INT           (43u)//PA03 : Digital Input : General interrupt from RTC or Extension boards  
